...
data_raw.describe(include = 'all') #see both numerical and categorical
...
print("Train1_bin Shape: {}".format(train1_x_bin.shape))
print("Train1_dummy Shape: {}".format(train1_x_dummy.shape))
print("Test1 Shape: {}".format(test1_x.shape))
print("Test1_bin Shape: {}".format(test1_x_bin.shape))
print("Test1_dummy Shape: {}".format(test1_x_dummy.shape))
...
# # Hard vote or soft vote don't improve the accuracy!!
# # So just simply select the best one XGBClassifier
...
submit_xgb = model_selection.GridSearchCV(XGBClassifier(), param_grid= {'learning_rate': [0.01,0.05,0.1,1], 'max_depth': [0,2,4,6,8,10], 'n_estimators': [10,50,100,200]}, scoring = 'roc_auc', cv = cv_split)
