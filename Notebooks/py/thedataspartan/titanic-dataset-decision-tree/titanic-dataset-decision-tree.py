...
sns.set_style('whitegrid')
sns.countplot(x='Survived',hue='Pclass',data=train,palette='rainbow',edgecolor=sns.color_palette("dark", 3))
...
test[['PassengerId', 'Survived']].to_csv('First_Decision_Tree_Classifier.csv', index=False)
