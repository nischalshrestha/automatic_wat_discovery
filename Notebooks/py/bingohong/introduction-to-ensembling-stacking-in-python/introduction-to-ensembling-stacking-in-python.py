...
#from sklearn.cross_validation import KFold; To_correct
...
#kf = KFold(ntrain, n_folds= NFOLDS, random_state=SEED)  to correct
...
#for i, (train_index, test_index) in enumerate(kf) To_Correct
