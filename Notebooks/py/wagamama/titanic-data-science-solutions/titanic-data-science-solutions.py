...
print(np.percentile(train_df['Survived'], [61, 62]))
print(np.percentile(train_df['Parch'], [75, 80]))
print(np.percentile(train_df['SibSp'], [68, 69]))
print(np.nanpercentile(train_df['Age'], [10, 20, 30, 40, 50, 60, 70, 80, 90, 99, 99.9]))
print(np.percentile(train_df['Fare'], [10, 20, 30, 40, 50, 60, 70, 80, 90, 99.9]))
