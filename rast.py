...
DOLLA = "\'$\'"
SPECIAL = "SPECIAL"
CALLS = ["c", "read.csv", "data.frame", "dim", "head", "slice", "filter", \
        "select", "distinct", "arrange", "rename", "mutate", "summary", \
        "summarise", "groupby"]
...
def parse_r(parsed_df):
    ...
    c, dim, head, slice, filter, select, distinct, arrange, rename, mutates, summary, summarise, groupby
    """
    valid = False
