...
# print(find_vars("full_data$Title[full_dataaaa[['Title']] == 'Mlle']"))
# print(replace_variable_name("full_data$Title[full_data[['Title']] == 'Mlle']", 'full_data'))
# var_to_raplce()
# print(find_vars("full$Mother[full$Sex == 'female' & full$Parch > 0 & full$Age > 18 & full$Title != 'Miss'] <- 'Mother'"))
# print(replace_variable_name("full$Mother[full$Sex == 'female' & full$Parch > 0 & full$Age > 18 & full$Title != 'Miss'] <- 'Mother'", 'full'))

# print(find_vars("select(df, 'a')"))
# variables <- find_vars("df %>% select(a) %>% filter(a > 1)")
# print(variables[[1]])
# print(replace_variable_name("df %>% select(a) %>% filter(a > 1)", variables[[1]]))
